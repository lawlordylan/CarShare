...
namespace CarShare
{
    [Activity(Label = "ViewOldPassengerJourneysActivity")]
    public class ViewOldPassengerJourneysActivity : Activity
    {
        ...
        protected async override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.ViewOldPassengerJourneys);
            userJourneys = await DBHelper.GetUsersOldPassengerJourneys(pref.GetString("UserID", ""));
            string[] items;
            ...
            lv = FindViewById<ListView>(Resource.Id.listViewPassengerOldJourney);
            lv.Adapter = adapter;
            lv.ItemClick += ListView_ItemClick;
            Button backBtn = FindViewById<Button>(Resource.Id.buttonPassengerOldJourneyBack);
