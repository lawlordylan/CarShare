...
namespace CarShare
{
    [Activity(Label = "ViewPassengerJourneysActivity")]
    public class ViewPassengerJourneysActivity : Activity
    {
        ...
        protected async override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.ViewUpcomingPassengerJourneys);
            userJourneys = await DBHelper.GetUsersPassengerJourneys(pref.GetString("UserID", ""));
            string[] items;
            ...
            lv = FindViewById<ListView>(Resource.Id.listViewPassengerJourney);
            lv.Adapter = adapter;
            lv.ItemClick += ListView_ItemClick;
            Button backBtn = FindViewById<Button>(Resource.Id.buttonPassengerJourneyBack);
